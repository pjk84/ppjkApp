        ...
        switch (Type)
        {
            case PieceType.P:
                ...
                if (move.Type == MoveType.Diagonal)
                {
                    if (move.Width > 1)
                    {
                        throw new Exception("move size exceeds diagonal move max of 1");
                    }
                ...
                if (move.Type == MoveType.Straight)
                {
                    ...
                    {
                        throw new Exception("forward attack move not allowed");
                    }
                }
                if (Color == Color.B)
                {
                    ...
                    {
                        throw new Exception("backwards move not allowed");
                    }
                }
                if (Color == Color.W)
                {
